      ...
      (e.__esModule = !0),
        (e.formatUrl = function (t) {
          ...
          (e = e ? encodeURIComponent(e).replace(/%3A/i, ':') + '@' : ''),
            t.host
              ? (c = e + t.host)
              : r && ((c = e + (~r.indexOf(':') ? '['.concat(r, ']') : r)), t.port && (c += ':' + t.port));
                        ...
                        switch ((n.prev = n.next)) {
                          ...
                          case 3:
                            return (
                              ...
                              (c = u.css),
                              (n.next = 8),
                              Promise.all([e.has(r) ? [] : Promise.all(s.map(p)), Promise.all(c.map(v))])
                            );
                          case 8:
                            return (
                              (l = n.sent),
    ...
    elyg: function (t, e, r) {
      ...
      function j(t, e) {
        var r = !(arguments.length > 2 && void 0 !== arguments[2]) || arguments[2],
          n = t.pathname,
          o = (0, s.removePathTrailingSlash)((0, l.denormalizePagePath)(r ? E(n) : n));
        return (
          '/404' === o ||
            '/_error' === o ||
            (e.includes(o) ||
                        ...
                        for (;;)
                          switch ((e.prev = e.next)) {
                            ...
                            case 50:
                              if (
                                ((b = j(b, D)).pathname !== O &&
                                  ((O = b.pathname), (o = (0, h.formatWithValidation)(b))),
                                (O = O ? (0, s.removePathTrailingSlash)(E(O)) : O),
                            ...
                            case 62:
                              if (((U = x(E(U), this.locale)), !(0, p.isDynamicRoute)(M))) {
                                e.next = 78;
                                break;
                              }
                              if (
                            ...
                            case 77:
                              B
                                ? (a = (0, h.formatWithValidation)(
                                    Object.assign({}, q, { pathname: V.result, query: C(I, V.params) })
                                  ))
                                : Object.assign(I, G);
                            case 78:
                              return (
                            ...
                            case 82:
                              ...
                              if ((j((et = (0, d.parseRelativeUrl)(tt)), D, !1), !D.includes(et.pathname))) {
                                e.next = 93;
                                break;
                              }
                              return (
                            ...
                            case 109:
                              return (
                                ...
                                (e.next = 116),
                                this.set(M, O, I, w, Y, u || (it || !i.scroll ? null : { x: 0, y: 0 })).catch(function (
                                  t
                                ) {
                            ...
                            case 21:
                              return (
                                ...
                                Promise.all([
                                  ...
                                  this.pageLoader[o.priority ? 'loadPage' : 'prefetch'](c)
                                ])
                              );
                            case 23:
                            case 'end':
